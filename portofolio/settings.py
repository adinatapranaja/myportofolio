...
SECRET_KEY = os.getenv(
    'SECRET_KEY', 'django-insecure-pzubtlluu!x)b)av$an)npuq17v+92w9&2l5p%$ft++)7exp%k'
)
...
ALLOWED_HOSTS = [
    ...
    for host in os.getenv(
        'ALLOWED_HOSTS',
        (
            'localhost,127.0.0.1,pws.cs.ui.ac.id,'
            'adinata-alaudin51-myportofolio.pws.cs.ui.ac.id,'
            'adinata.alaudin51-myportofolio.cs.ui.ac.id'
        ),
    ).split(',')
    if host.strip()
]
